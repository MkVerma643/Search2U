...
<div id="Navigation">
<ul class="ul">
  <li class="li"><a class="active_link" href="">&nbsp;&nbsp;&nbsp;All&nbsp;&nbsp;&nbsp;</a></li>
  ...
  <li class="li"><a class="link" href="search2u4.php?search=<?php echo $search; ?>&submit=   Search">&nbsp;&nbsp;&nbsp;News&nbsp;&nbsp;&nbsp;</a></li>
...
$constructs ="SELECT * FROM db WHERE $construct";
$run = mysql_query($constructs);
    

 if($search=='Binary Search'||$search=='BINARY SEARCH'||$search=='binary search'||$search=='binarysearch')
{
	include('Binary.php');
}
else{
...
if(!$start)
$start=0; 
$getquery = mysql_query("SELECT * FROM db WHERE $construct LIMIT $start, $per_page");
...
echo "<h3><a href='".$link."'>".$title."</a></h3><pre>".$link."</pre><p>".$body."</p>";
echo"<hr>";
...
//previous button
if (!($start<=0)) 
echo " <a href='search2u1.php?search=$search&submit=Search+source+code&start=$prev'>Prev</a> ";    
...
{
if ($i == $start){
echo " <a href='search2u1.php?search=$search&submit=Search+source+code&start=$i'><b>$counter</b></a> ";
}
else {
echo " <a href='search2u1.php?search=$search&submit=Search+source+code&start=$i'>$counter</a> ";
}  
$i = $i + $per_page;                 
}
}
...
{
echo " <a href='search2u1.php?search=$search&submit=Search+source+code&start=0'>1</a> ";
echo " <a href='search2u1.php?search=$search&submit=Search+source+code&start=$per_page'>2</a> .... ";
...
echo " <a href='search2u1.php?search=$search&submit=Search+source+code&start=$next'>Next</a> ";    
}   
echo "</center>";
} 
} 
...
&nbsp;&nbsp;&nbsp;|</li>&nbsp;&nbsp;&nbsp;
    ...
    <p><strong>Copyright <b>©</b> 2016 Search2U, All Rights Reserved.</strong>
    </p>
  </div>
</div>
<!-- Footer Ends-->
