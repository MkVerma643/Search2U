...
<div class="Content">
<br>
<form method="get" action="search2u2.php">
  <a href="search2U.php">
...
<ul class="ul">
  ...
  <li class="li"><a class="active_link" href="" >&nbsp;&nbsp;&nbsp;Images&nbsp;&nbsp;&nbsp;</a></li>
...
$constructs ="SELECT * FROM images WHERE $construct";
...
if(!$start)
$start=0; 
$getquery = mysql_query("SELECT * FROM images WHERE $construct LIMIT $start, $per_page");
...
echo "<h3><a href='".$link."' target='_blank'>".$title."</h3><img src=".$link." width='300px' height='250'></a><p>".$body."</p>";
echo"<hr>";
...
//previous button
if (!($start<=0)) 
echo " <a href='search2u2.php?search=$search&submit=Search+source+code&start=$prev'>Prev</a> ";    
...
{
if ($i == $start){
echo " <a href='search2u2.php?search=$search&submit=Search+source+code&start=$i'><b>$counter</b></a> ";
}
else {
echo " <a href='search2u2.php?search=$search&submit=Search+source+code&start=$i'>$counter</a> ";
}  
$i = $i + $per_page;                 
}
}
...
{
echo " <a href='search2u2.php?search=$search&submit=Search+source+code&start=0'>1</a> ";
echo " <a href='search2u2.php?search=$search&submit=Search+source+code&start=$per_page'>2</a> .... ";
...
echo " <a href='search2u2.php?search=$search&submit=Search+source+code&start=$next'>Next</a> ";    
}   
echo "</center>";
} 
} 
