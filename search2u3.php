...
<div class="Content">
<br>
<form method="get" action="search2u3.php">
  <a href="search2U.php">
...
<ul class="ul">
  ...
  <li class="li"><a class="link" href="search2u2.php?search=<?php echo $search; ?>&submit=   Search" >&nbsp;&nbsp;&nbsp;Images&nbsp;&nbsp;&nbsp;</a></li>
   <li class="li"><a class="active_link" href="" >&nbsp;&nbsp;&nbsp;Videos&nbsp;&nbsp;&nbsp;</a></li>
...
echo "<br><video width='500' height='250' controls>
  		<source src='".$link."' type='video/mp4'>
  		<source src='".$link."' type='video/ogg'>
  		Your browser does not support the video tag.
		</video> <p>".$body."</p>"."<h3>Download: <a href='".$link."'>".$title."</a></h3>";
echo"<hr>";   
}
 echo"<br>";
...
//previous button
if (!($start<=0)) 
echo " <a href='search2u3.php?search=$search&submit=Search+source+code&start=$prev'>Prev</a> ";    
...
{
if ($i == $start){
echo " <a href='search2u3.php?search=$search&submit=Search+source+code&start=$i'><b>$counter</b></a> ";
}
else {
echo " <a href='search2u3.php?search=$search&submit=Search+source+code&start=$i'>$counter</a> ";
}  
$i = $i + $per_page;                 
}
}
...
{
echo " <a href='search2u3.php?search=$search&submit=Search+source+code&start=0'>1</a> ";
echo " <a href='search2u3.php?search=$search&submit=Search+source+code&start=$per_page'>2</a> .... ";
...
{
if ($i == $start){
echo " <a href='search2u13.php?search=$search&submit=Search+source+code&start=$i'><b>$counter</b></a> ";
}
else {
echo " <a href='search2u3.php?search=$search&submit=Search+source+code&start=$i'>$counter</a> ";   
} 
...
echo " <a href='search2u3.php?search=$search&submit=Search+source+code&start=$next'>Next</a> ";    
}   
echo "</center>";
} 
} 
